...
urlpatterns = [
    ...
    path("schedules/<int:schedule_pk>/overrides/create/", views.override_create, name="override-create"),
    path("overrides/<int:pk>/edit/", views.override_edit, name="override-edit"),
    path("overrides/<int:pk>/delete/", views.override_delete, name="override-delete"),
